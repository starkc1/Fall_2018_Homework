...
/**
 *
 * @author dgb Date: 11/23/2018 This program does a simple simulation of a print
 *         server serving print jobs that have priorities of 1 (highest), 2, or
 *         3 (lowest). It uses a min heap to queue the jobs arriving at printer.
 *         Each iteration of the for loop in the runSimulation method is
 *         considered to be a unit of time and something happens within that
 *         unit of time. Probabilities are used to model the random way that
 *         events occur and to determine both the priority of the job and the
 *         amount of units of time that the job is required. Certain statistics
 *         are calculated and displayed after the loop exits. Each job is
 *         represented by an object of the PrintJob class.
 */
public class PrintSchedulingSimulation2 {
    public static void main(String[] args) {
        ...
        while (numIterations != 0) {
            ...
            // avgNumUnitsPerJobArrival = Double.parseDouble(scanner.nextLine());
